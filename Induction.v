...
Theorem dist_m: forall m n: nat,  m*(S n) = m+ m*n.
Proof.
...
Proof.
  ...
  -simpl. reflexivity.
  -simpl. rewrite add_0_r. reflexivity.
  -simpl. rewrite add_0_r. rewrite add_0_r. rewrite IHb'. simpl. rewrite add_comm. reflexivity.
Qed.
(** [] *)
...
Lemma double_bin_lemma: forall b, nat_to_bin(b+b) = double_bin(nat_to_bin b).
Proof.
  intros b. induction b.
  - reflexivity.
  - simpl. rewrite add_comm. simpl. rewrite IHb. rewrite double_incr_bin. reflexivity.
...
Proof.
  intros. induction b.
  -simpl. reflexivity.
  -simpl. rewrite add_0_r. rewrite double_bin_lemma. rewrite IHb. reflexivity.
  -simpl. rewrite add_0_r. rewrite double_bin_lemma. rewrite IHb. rewrite incr_double_bin. reflexivity.
Qed.
(** [] *)
